...
typealias ClipboardContext = javafx.scene.input.ClipboardContent

typealias DataFormat = javafx.scene.input.DataFormat

typealias Dragboard = javafx.scene.input.Dragboard

typealias InputMethodRequests = javafx.scene.input.InputMethodRequests

typealias InputMethodTextRun = javafx.scene.input.InputMethodTextRun

typealias KeyCharacterCombination = javafx.scene.input.KeyCharacterCombination

typealias KeyCodeCombination = javafx.scene.input.KeyCodeCombination

typealias KeyCombination = javafx.scene.input.KeyCombination

typealias Mnemonic = javafx.scene.input.Mnemonic

typealias PickResult = javafx.scene.input.PickResult

typealias TouchPoint = javafx.scene.input.TouchPoint
...
typealias KeyCode = javafx.scene.input.KeyCode
